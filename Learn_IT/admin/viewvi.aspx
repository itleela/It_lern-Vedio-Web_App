<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="viewvi.aspx.cs" Inherits="admin_viewc" %>
    ...
    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>  <video width="200" height="150" controls  poster=' <%# Eval("poster") %>'   runat="server">
                                             ...
                                             <td>
                                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/admin/edit_vedio.aspx?id="+Eval("Id") %>'>Edit</asp:HyperLink></td>
