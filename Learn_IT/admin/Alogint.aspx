<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alogint.aspx.cs" Inherits="admin_Alogint" %>
                            ...
                            <div class="col-lg-6" style="margin-top:100px">
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Learn IT Expert</h1>
                                    </div>
                               ...
                               <br />
                                   <a href="../Home.aspx" class="btn btn-primary ">
                                     ...
                                     <a href="/admin/register_exp.aspx" class="btn btn-primary ">
